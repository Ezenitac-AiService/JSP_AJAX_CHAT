...
- [ ] **TASK-01-01**: `docker-compose.yml` 파일 작성 (MySQL 8.0 기반)
  - `Document/chat.sql`을 초기화용 볼륨으로 마운트
  - Root 비밀번호: `ezen`, DB명: `chatdb` 설정
- [ ] **TASK-01-02**: 프로젝트 설정 파일(`docs/PROJECT-CONFIG.md`) 생성 및 Java 17/Tomcat 9(또는 10) 사양 명시
- [ ] **TASK-01-03**: Docker 컨테이너 구동 및 `DBManager` 연결 테스트 코드 작성
